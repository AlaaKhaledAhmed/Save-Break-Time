...
IconData cafeIcon=Icons.notifications;
IconData bookIcon=Icons.notifications;
...
//Navigator menu--------------------------------------------------------
  ...
  List <Widget>studentPage=[BookStoreMain(),CafeteriaMain(),RequestMain(),StudentNotification()];