...
class BookWorkerUpdateProduct extends StatefulWidget {
  final addImage;
  final addPrice;
  final addQuantity;
  final addName;
  ...
  @override
  State<BookWorkerUpdateProduct> createState() => _BookWorkerUpdateProductState();
}

class _BookWorkerUpdateProductState extends State<BookWorkerUpdateProduct> {
