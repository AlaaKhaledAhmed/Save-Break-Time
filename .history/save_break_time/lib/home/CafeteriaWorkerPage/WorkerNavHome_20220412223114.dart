...
import '../BookStore/BookWorkerNotification/BookWorkerNotification.dart';
import '../BookStore/BookWorkerProducts/BookWorkerProduct.dart';
import '../BookStore/BookWorkerRequest/BookWorkerRequest.dart';
import 'WorkerNotification/WorkerNotification.dart';
...
class _WorkerNavHomeState extends State<WorkerNavHome> {
  ...
  List <Widget>workerPage=[WorkerNotification(),ProductMainPage(),WorkerRequest()];
