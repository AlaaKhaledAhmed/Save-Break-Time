              ...
              child: Card(
                  ...
                  child: Column(
                    children: [
                      ...
                      Expanded(
                        flex: 1,
                        child: textDB(context, "${snapshat.data.docs[i].data()['prName']}", 15, black,
                            fontWeight: FontWeight.w700),
                      ),
                      Expanded(
                          flex: 1,
                          child: textDB(context,
                               "${snapshat.data.docs[i].data()['prPrice']} " + getTranslated(context, 'SAR'), 15, black,
                              fontWeight: FontWeight.w700)),
                    ],
                  )),
            ),
