...
// ignore: missing_return
  ...
  Widget build(BuildContext context) {
    newName = TextEditingController(text: widget.addName);
    newprice = TextEditingController(text: widget.addPrice);
    newquantity = TextEditingController(text: widget.addQuantity);
    return Scaffold(
      appBar: widget.pagTaype == 'add'
          ? drowAppBar("Add products", context)
          : drowAppBar("Edit products", context),
      body: Padding(
...
//quantity-----------------------------------------------------------
                        textField(
                          ...
                          "Quantity",
                          hiddText,
                          widget.pagTaype == 'add' ? prQuantity : newquantity,
                          validEmpty,
                          keyboardType: TextInputType.phone,
                          inputFormatters: [
                            FilteringTextInputFormatter.digitsOnly
  ...
  Future<void> updateProduct() async {
    ...
    if (fileImage == null) {
      await FirebaseFirestore.instance
        ...
        'prName': newName.text,
        'prPrice': newprice.text,
        'prQuantity': newquantity.text,
      }).then((value) {
        Navigator.pop(context);
        dialog(
          context,
      ...
      await FirebaseFirestore.instance.collection('product').doc(widget.addId).update({
