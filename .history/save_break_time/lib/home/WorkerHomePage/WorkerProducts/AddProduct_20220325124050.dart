...
// ignore: missing_return
  ...
  Widget build(BuildContext context) {
    var newName=prName.text=widget.addName;
    var newprice=prName.text=widget.addPrice;
    var newquantity=prName.text=widget.addQuantity;
    return Scaffold(
...
//name-----------------------------------------------------------
                        textField(
                          ...
                          "product name",
                          hiddText,
                         widget.pagTaype=='add'? prName:new,
                          validEmpty,
