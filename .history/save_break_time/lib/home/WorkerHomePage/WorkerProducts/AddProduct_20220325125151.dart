...
class _AddProductState extends State<AddProduct> {
  ...
  final TextEditingController prQuantity = TextEditingController();
   TextEditingController newName,newprice,newq
  String imageName;
  Reference imageRef;
  String imageURL;
  File imagePath;
...
// ignore: missing_return
  ...
  Widget build(BuildContext context) {
    TextEditingController newName=TextEditingController(text: widget.addName);
    TextEditingController newprice=TextEditingController(text: widget.addPrice);
    TextEditingController newquantity=TextEditingController(text: widget.addQuantity);
    return Scaffold(
