...
//----------------------------------------------------------------
                Expanded(
                    child: StreamBuilder(
                        stream: productCollection.where("userID", isEqualTo: FirebaseAuth.instance.currentUser.uid).snapshots(),
                        builder:
    ...
    return GridView.builder(
        ...
        itemBuilder: (context, i) {
          return InkWell(
            onLongPress: () {
              deleteProduct(
                snapshat.data.docs[i].id,snapshat.data.docs[i].data()['imagePath']
              );
            },
            child: SizedBox(
              height: 180.h,
